...
CREATE TABLE `books` (
  ...
  `book_publisher` varchar(120) DEFAULT NULL,
  `book_publishdate` date DEFAULT NULL,
  `book_edition` int DEFAULT NULL,
  `book_numpages` int DEFAULT NULL,
  `book_language` varchar(30) DEFAULT NULL,
  `book_type` varchar(30) DEFAULT NULL,
  `book_material` varchar(20) DEFAULT NULL,
  `book_blurb` text,
  `book_covertype` varchar(20) DEFAULT NULL,
  `book_condition` int DEFAULT NULL,
  `book_series` int DEFAULT NULL,
  `book_subject` text,
  `book_available` tinyint(1) DEFAULT '1',
  `author_id` int DEFAULT NULL,
  PRIMARY KEY (`id_book`),
  UNIQUE KEY `book_isbn` (`book_isbn`),
  KEY `author_id` (`author_id`),
  CONSTRAINT `books_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `author` (`id_author`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-06-02 22:52:32
